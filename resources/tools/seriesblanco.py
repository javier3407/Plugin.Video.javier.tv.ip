# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Parser de SeriesBlanco para PalcoTV
...
def seriesblanco2(params):
    ...
    getlink_seriesblanco(params,show)



def getlink_seriesblanco(params,show):
...
def gethttp_referer_headers(url,referer,show):
    #plugintools.log('[%s %s] gethttp_referer_headers % (addonName, addonVersion))
