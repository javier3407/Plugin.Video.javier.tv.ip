...
def seriesmu(params):
    plugintools.log('[%s %s] Series.Mu %s' % (addonName, addonVersion, repr(params)))
...
def seriesmu0(params):
    plugintools.log('[%s %s] Seriesmu0 %s' % (addonName, addonVersion, repr(params)))
...
def enlacesmu(params):
    plugintools.log('[%s %s] enlacesmu %s' % (addonName, addonVersion, repr(params)))
