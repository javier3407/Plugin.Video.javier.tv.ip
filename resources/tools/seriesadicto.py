...
def GetSerieChapters(params):
    plugintools.log('[%s %s] GetSerieChapters %s' % (addonName, addonVersion, repr(params)))
...
def GetSerieLinks(params):
    plugintools.log('[%s %s] GetSerieLinks %s' % (addonName, addonVersion, repr(params)))
    ...
    for entry in matches:
        ...
        if page_url.find("novamov") >= 0:
            server_url = "[COLOR lightgreen][I][novamov][/I][/COLOR]"
            plugintools.add_item(action="novamov", title = title_fixed+' '+server_url+' '+audio_url , url = page_url , thumbnail = thumbnail_fixed, info_labels = datamovie , fanart = fanart, folder = False, isPlayable = True)
        elif page_url.find("moevideos") >= 0:
            server_url = "[COLOR lightgreen][I][moevideos][/I][/COLOR]"
            plugintools.add_item(action="moevideos", title = title_fixed+' '+server_url+' '+audio_url , url = page_url , thumbnail = thumbnail_fixed, info_labels = datamovie , fanart = fanart, folder = False, isPlayable = True)
        elif page_url.find("gamovideo") >= 0:
            server_url = "[COLOR lightgreen][I][gamovideo][/I][/COLOR]"
            plugintools.add_item(action="gamovideo", title = title_fixed+' '+server_url+' '+audio_url , url = page_url , thumbnail = thumbnail_fixed, info_labels = datamovie , fanart = fanart, folder = False, isPlayable = True)
        elif page_url.find("movshare") >= 0:
            server_url = "[COLOR lightgreen][I][movshare][/I][/COLOR]"
            plugintools.add_item(action="movshare", title = title_fixed+' '+server_url+' '+audio_url , url = page_url , thumbnail = thumbnail_fixed, info_labels = datamovie , fanart = fanart, folder = False, isPlayable = True)            
        elif page_url.find("videobam") >= 0:
            server_url = "[COLOR lightgreen][I][videobam][/I][/COLOR]"
            plugintools.add_item(action="videobam", title = title_fixed+' '+server_url+' '+audio_url , url = page_url , thumbnail = thumbnail_fixed, info_labels = datamovie , fanart = fanart, folder = False, isPlayable = True)
        elif page_url.find("powvideo") >= 0:
            server_url = "[COLOR lightgreen][I][powvideo][/I][/COLOR]"
            plugintools.add_item(action="powvideo", title = title_fixed+' '+server_url+' '+audio_url , url = page_url , thumbnail = thumbnail_fixed, info_labels = datamovie , fanart = fanart, folder = False, isPlayable = True)
        elif page_url.find("veehd") >= 0:
            server_url = "[COLOR lightgreen][I][veehd][/I][/COLOR]"
            plugintools.add_item(action="veehd", title = title_fixed+' '+server_url+' '+audio_url ,url = page_url , thumbnail = thumbnail_fixed, info_labels = datamovie , fanart = fanart, folder = False, isPlayable = True)
        elif page_url.find("mail.ru") >= 0:
            server_url = "[COLOR lightgreen][I][mail.ru][/I][/COLOR]"
            plugintools.add_item(action="mailru", title = title_fixed+' '+server_url+' '+audio_url , url = page_url , thumbnail = thumbnail_fixed, info_labels = datamovie , fanart = fanart, folder = False, isPlayable = True)            
...
def SelectTemp(params, temp):
    plugintools.log('[%s %s] SelectTemp %s' % (addonName, addonVersion, repr(params)))    
